...
║  Versión: 1.6 | Python 3.11+ | Auth: RSA-PSS                   ║
...
EVOLUCION_PRECIO_MIN = 0.20
EVOLUCION_PRECIO_MAX = 0.90
...
class PaperEngine:
    ...
    async def reg_evolucion(self, mid, ticker, spot, strike, yes_ask):
        """
...
async def _evaluar(shared:SharedState,paper:PaperEngine):
    ...
    await paper.reg_evolucion(mid,ticker,spot,strike,yes_ask)
...
async def main():
    ...
    print("""
╔══════════════════════════════════════════════════════════╗
║   📋  KALSHI BTC BOT — PAPER TRADING  v1.6              ║
