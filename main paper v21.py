...
║  Versión: 2.1 | Python 3.11+ | Auth: RSA-PSS                   ║
...
def _mejor_ask(libro: dict) -> float:
    """Precio mas bajo del libro con cantidad > 0 (mejor oferta de venta)."""
    precios_validos = [float(p) for p, q in libro.items() if float(q) > 0]
...
async def main():
    ...
    print("""
╔══════════════════════════════════════════════════════════╗
║   📋  KALSHI BTC BOT — PAPER TRADING  v2.1              ║
