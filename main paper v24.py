...
║  Versión: 2.4 | Python 3.11+ | Auth: RSA-PSS                   ║
...
def evaluar_entrada_no(obi,momentum,spot,strike,no_ask):
    """
    ...
    """
    r_yes = calcular_probabilidad_real(obi,momentum,spot,strike)
...
async def _evaluar(shared:SharedState,paper:PaperEngine):
    ...
    buy_no, r_no = evaluar_entrada_no(obi, mom, spot, strike, no_ask)
    if buy_no:
...
async def main():
    ...
    print("""
╔══════════════════════════════════════════════════════════╗
║   📋  KALSHI BTC BOT — PAPER TRADING  v2.4              ║
